    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-background/80 p-6">
      <div className="mx-auto max-w-6xl">
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Motion Capture Studio</h1>
          <p className="mt-2 text-muted-foreground">Speak to animate the 3D model in real-time</p>
        </div>
